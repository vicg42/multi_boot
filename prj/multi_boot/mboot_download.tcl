write_cfgmem -force -format mcs -size 32 -interface spix4 -verbose \
             -loadbit "up 0 ../golden/firmware/golden.bit up 0x00400000 ../update/firmware/update.bit" multi_boot.mcs
...
create_hw_cfgmem -hw_device [lindex [get_hw_devices] 0] -mem_device [lindex [get_cfgmem_parts {n25q256-3.3v-spi-x1_x2_x4}] 0]
...
set_property PROGRAM.FILES [list "./multi_boot.mcs" ] \
